...
public class LivroRequest {
    ...
    @Size(min = 3, max = 254, message = "O título deve ter entre e 254 caracteres")
    private String titulo;
    @NotBlank(message = "O nome do autor deve ter entre 3 150 caracteres)
    @Size(min = 3, max = 150, message = "O título deve ter entre e 150 caracteres")
